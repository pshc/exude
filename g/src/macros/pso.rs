...
macro_rules! gfx_pipeline_inner {
    {
        ...
        use $crate::gfx::pso::{DataLink, DataBind, Descriptor, InitError, RawDataSet, AccessInfo};

        #[derive(Clone, Debug)]
        pub struct Data<R: $crate::gfx::Resources> {
        ...
        impl<'a> $crate::gfx::pso::PipelineInit for Init<'a> {
            type Meta = Meta;
        ...
        impl<R: $crate::gfx::Resources> $crate::gfx::pso::PipelineData<R> for Data<R> {
            type Meta = Meta;
            fn bake_to(&self,
                       out: &mut RawDataSet<R>,
                       meta: &Self::Meta,
                       man: &mut $crate::gfx::handle::Manager<R>,
