...
macro_rules! gfx_format {
    ($name:ident : $surface:ident = $container:ident<$channel:ident>) => {
        impl $crate::gfx::format::Formatted for $name {
            type Surface = $crate::gfx::format::$surface;
            type Channel = $crate::gfx::format::$channel;
            type View = $crate::gfx::format::$container<
                <$crate::gfx::format::$channel as $crate::gfx::format::ChannelTyped>::ShaderType
                >;
        }
    }
}
